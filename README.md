...
Aplicación backend desarrollada en Java 17 con Spring Boot, que permite gestionar las atenciones médicas de pacientes en un sistema de salud. El proyecto implementa autenticación mediante JWT, seguridad con Spring Security, y se conecta a una base de datos PostgreSQL para el registro y consulta de datos médicos.
...
- Crear la base de datos bd_gestion_atenciones en pgAdmin.
- Configurar el archivo application.properties con los datos de conexión.
- Ejecutar el backend desde IntelliJ IDEA.
- Probar los endpoints en Postman, enviando el token JWT en los headers.
- (Opcional) Conectar este backend a un frontend desarrollado en Angular o React.
...
Incluye ejemplos de requests y responses para probar la API en Postman, con token JWT de prueba.
